...
<body>
    ...
    <div class="section1" align="center" style="  margin-bottom: 20px;">
        <div style="margin-top: 50px">
            ...
            <h1 class="alert-danger">Choose a Vaccine
        </div>

        <div class="custom-select"
            style="font-size: 29px;font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, 'sans-serif'">
