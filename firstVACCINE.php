...
<body>
    ...
    <div class="section1" align="center" style="  margin-bottom: 20px;">
        ...
        <div style="margin-top: 80px">
            ...
            <h2><mark>If you want to change the selected vaccine click here...<a href="one.php"><button
                            style="width: 60px" class="btn btn-warning btn-md"><i
                                class="fas fa-shield-virus"></button></a></h2>
            <br>
...
?>
            ...
            <form action="" method="post">
                ...
                <input type="submit"
                    style="width: 400px; font-family: 'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, 'sans-serif';font-size: 28px"
                    class="btn btn-Primary btn-lg" value="Request for your first Vaccine" name="submit" />
            </form>
        </div>
